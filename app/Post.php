...
class Post extends Eloquent {
    ...
    {
        return $this->hasMany('App\TermRelation', 'object_id')->with('category');
    }
    ...
    {
        $categories = array();
        $term_relation = $this->termRelation()->get();
//        print_r($term_relation);
        foreach ($term_relation as $termRelation) {
